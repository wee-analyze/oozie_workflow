...
aggvisits = FOREACH visits GENERATE group as log_date, COUNT(filteredlines) as visits, 
MIN(filteredlines.log_time) as first, MAX(filteredlines.log_time) as last;
